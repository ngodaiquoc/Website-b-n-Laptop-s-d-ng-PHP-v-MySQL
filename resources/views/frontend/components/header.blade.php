...
<div class="commonTop" style="position: unset !important;">
    <div id="headers" style="background-color:#82ae89!important;">
        <div class="container header-wrapper">
            <!--Thay đổi-->
            <div class="logo">
                <a href="{{  route('get.home') }}" class="desktop">
                    <img src="{{ asset('images/logo.png') }}" style="height: 39px;width: 180px;" alt="Home">
                </a>
                <span class="menu js-menu-cate-new"><i class="fa fa-list-ul"></i> </span>
            </div>
            <div class="search">
